(module
 ...
 (memory $0 1)
 (data (i32.const 8) "\10\00\00\00\00\00\00\00\01\00\00\00\02\00\00\00\03\00\00\00\05\00\00\00\00\00\00\00\00\00\00\00")
 (data (i32.const 40) "\08\00\00\00\04\00\00\00")
 (export "memory" (memory $0))
 (export "add" (func $assembly/module/add))
 (export "fib" (func $assembly/module/fib))
 (func $~lib/array/Array<i32>#__get (; 0 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  ;;@ ~lib/array.ts:70:4
  (set_local $2
   ;;@ ~lib/array.ts:70:17
 ...
 (func $assembly/module/add (; 1 ;) (type $i) (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  ;;@ assembly/module.ts:2:4
  (set_local $0
   ;;@ assembly/module.ts:2:20
   (i32.const 0)
  )
  ...
  (block $break|0
   ;;@ assembly/module.ts:4:8
   (set_local $2
    ;;@ assembly/module.ts:4:14
    (i32.const 0)
   )
   (loop $repeat|0
    (br_if $break|0
 ...
 (func $assembly/module/fib (; 2 ;) (type $ii) (param $0 i32) (result i32)
